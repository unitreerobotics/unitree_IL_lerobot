            ...
            while True:
                ...
                if cfg.sim and cfg.save_data:
                    ...
                    if (reward_sum >= 25):    
                        ...
                        logger_mp.info(f"Episode {episode_num} finished with reward {reward_sum},save data...")
                        episode_num =-1
                        reward_sum = 0
                        time.sleep(0.5)
                        ...
                        sim_reward_subscriber.reset_data()
                    # fail
                    elif episode_num > cfg.max_episodes:
                        process_data_save(episode_writer,"fail")
                        logger_mp.info(f"Episode {episode_num} finished with reward {reward_sum}")
                        episode_num =-1
                        reward_sum = 0
                        reset_policy(policy)
                        sim_reward_subscriber.reset_data()
